...
<body>
 ...
 <ul class="site1">
        ...
        <ul class="site">
            <li><a href="<?php echo site_url("Adduser/form_validation")?>">Add User</a>
            </li>
            <li><a href="<?php echo site_url ("Admin_c/adminupdatedelete")?>">Update/Delete User</a>
            </li>
            <li><a href="<?php echo site_url("Admin_c/adminupdate")?>">Update User</a>
            </li>
        </ul>
