...
<div class="contact wthree-3">
    ...
    <div class="col-md-3 content-pro-head1 w3agile-6">
        ...
        <h3 class="tittle">My Payments</h3>
    </div>
  <div class="col-md-9 content-pro-head1 w3agile-6">
    <!--<h2 class="tittle">Expenses</h2> -->
      <div class="bs-docs-example">
              ...
              if ($row->PayerId==$usname){
							 ...
							 echo '<td>';
							 echo ' ';
							 $deleteString=site_url('payments/delete_payment/').$row->Pid;
							 echo "<a class='btn btn-danger' href='".$deleteString."'> Delete</a>";
							 echo '</td>';
							 }
               }
        ...
        <p>
              <a href="<?php echo site_url("payments/createpayment")?>" class="btn btn-success">Create</a>
          </p>
			</div>
